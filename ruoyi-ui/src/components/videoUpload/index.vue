...
<!--        <video v-if="dialogImageUrl" muted :src="dialogImageUrl" width="200" height="200" class="avatar"/>-->
        <div class="video-thum" v-if="file.url">
          <video  muted :src="file.url" width="160" height="160" class="avatar" @click="handlePictureCardPreview(file)"/>
    ...
    >
      <div class="video-preview">
        <video controls muted width="600px" height="400px" :src="dialogImageUrl"></video>
      </div>
